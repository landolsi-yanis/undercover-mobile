            ...
            mainContent={
                <>
                    <MessageBox
                        largeHeight={true}
                        headerContent={<>
                            <div className='showWWordPagePlayerIdentity'><img src={playerPicture} alt='Player Picture'
                                                                              className='showWWordPagePlayerPicture'/>{props.selectedPlayer}
                            </div>
                            <div
                                className='showWWordPagePlayerInfo'>{getCurrentPlayer()?.role === 'Mr White' ? <>Chttttt
                                you are Mr White<br/>Good luck !</> : <>Memorize your word <br/> (you will never see it
                                again)</>
                            }</div>
                        </>}
                        mainContent={<div
                            className='showWWordPageWord'>{getCurrentPlayer()?.role === 'Undercover' && props.undercoversWords} {getCurrentPlayer()?.role === 'Citizen' && props.citizensWords}{getCurrentPlayer()?.role === 'Mr White' && '*****'}</div>}
